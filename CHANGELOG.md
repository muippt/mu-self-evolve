...
- ✨ Bias audit — `bias_audit.py` injects synthetic test entries with known properties to verify the eviction mechanism hasn't silently degraded (inspired by "The Blind Curator")
